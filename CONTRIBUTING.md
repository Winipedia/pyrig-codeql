...
Thanks for considering a contribution to pyrig-codeql! Following
...
opening a new issue, search [existing issues](https://github.com/Winipedia/pyrig-codeql/issues)
to avoid duplicates.
...
- All checks in [CI](https://github.com/Winipedia/pyrig-codeql/actions/workflows/health_check.yml) must pass before merge.
